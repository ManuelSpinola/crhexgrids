...
```{r}
#| fig-cap: "Figura 1. Hexagonal grid of resolution 5 for Costa Rica."
...
```{r}
#| fig-cap: "Figura 2. Hexagonal grid of resolution 6 for Costa Rica."
...
```{r}
#| fig-cap: "Figura 3. Hexagonal grid of resolution 7 for Costa Rica."
